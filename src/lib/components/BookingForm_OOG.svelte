...
<!--        <p class="hero-description">Get an appointment with our experienced accountants</p>-->
<!--        <img class="hero-image" src="https://images.unsplash.com/photo-1504672281656-e4981d70414b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />-->
<!--    </div>-->
            ...
            <div class="service-options">
                <div class="service-option">
                    ...
                    <label class="service-option-label" for="radio_1">
                        <span class="service-option-title">Financial Planning</span>
                ...
                <div class="service-option">
                    ...
                    <label class="service-option-label" for="radio_2">
                        <span class="service-option-title">Retirement Planning</span>
                        <span class="service-option-duration">1 Hour</span>
                    </label>
                </div>
                <div class="service-option">
                    ...
                    <label class="service-option-label" for="radio_3">
                        <span class="service-option-title">Investment Advice</span>
                        <span class="service-option-duration">1 Hour</span>
                    </label>
                </div>
            </div>
